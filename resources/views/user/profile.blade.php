            ...
            <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                ...
                <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div>
                        ...
                        <div class="mt-1 flex items-center space-x-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="mt-1 text-sm text-gray-500">Upload Foto Profil Baru (JPG, PNG, max 5MB)</p>
                            </div>
                        </div>
                        @error('profile_image')
                    ...
                    <div class="border-t border-gray-200 pt-6">
                        ...
                        <p class="text-sm text-gray-600 mb-4">Kosongkan Jika tidak Ingin Merubahnya</p>
            ...
            <div class="bg-white rounded-lg shadow-sm overflow-hidden mt-6">
                ...
                <div class="px-6 py-4">
                    <dl class="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                        ...
                        <div>
                            <dt class="text-sm font-medium text-gray-500">Member Sejak</dt>
                            <dd class="mt-1 text-sm text-gray-900">{{ $user->created_at->format('F d, Y') }}</dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-500">Terakhir di Update</dt>
                            <dd class="mt-1 text-sm text-gray-900">{{ $user->updated_at->format('F d, Y \a\t H:i') }}</dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-500">Verifikasi Email</dt>
        ...
        function previewImage(event) {
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    preview.innerHTML =
                        `<img src="${e.target.result}" class="w-20 h-20 rounded-full object-cover border-2 border-gray-200" alt="Preview">`;
