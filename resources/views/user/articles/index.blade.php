        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div class="mb-12">
                <div class="flex flex-wrap justify-center gap-4">
                    <a href="{{ route('articles.index') }}"
                        class="px-6 py-3 rounded-full font-medium transition-all duration-200 {{ !$selectedCategory ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-lg' : 'bg-white text-gray-700 hover:bg-gray-50 border border-gray-200' }}">
                        Semua Kategori
                    </a>
                    @foreach($categories as $category)
                        <a href="{{ route('articles.index', ['category' => $category->id]) }}"
                            class="px-6 py-3 rounded-full font-medium transition-all duration-200 {{ $selectedCategory == $category->id ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-lg' : 'bg-white text-gray-700 hover:bg-gray-50 border border-gray-200' }}">
                            {{ $category->name }}
                        </a>
                    @endforeach
                </div>
                        ...
                        <article class="bg-white rounded-3xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 border border-gray-100 group">
                            <a href="{{ route('articles.show', $article->slug) }}" class="block">
                                <div class="relative overflow-hidden">
                                    ...
                                    @else
                                        <div class="w-full h-56 bg-gradient-to-br from-blue-100 via-purple-50 to-pink-100 flex items-center justify-center">
                                ...
                                <div class="p-8">
                                    <h2 class="text-2xl font-bold text-gray-900 mb-4 line-clamp-2 group-hover:text-blue-600 transition-colors duration-300">
                                        {{ $article->title }}
                                    </h2>
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <span class="flex items-center text-blue-600 font-semibold text-sm group-hover:text-blue-700 transition-colors">
            ...
            @else
                ...
                <div class="text-center py-20">
                    <div class="w-32 h-32 bg-gradient-to-br from-blue-100 via-purple-50 to-pink-100 rounded-full flex items-center justify-center mx-auto mb-8 shadow-2xl">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        @if($selectedCategory)
                            <a href="{{ route('articles.index') }}"
                                class="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-2xl hover:from-blue-600 hover:to-blue-700 transition-all duration-300 font-semibold shadow-xl hover:shadow-2xl transform hover:-translate-y-1">
