                ...
                <div class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                    <div class="flex items-center mb-8">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 mt-1">Where should we deliver your order?</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <textarea id="address"
                                      ...
                                      placeholder="Enter your complete shipping address including street name, building number, city, postal code, and any landmarks..."
                        ...
                        <div>
                            <label for="notes" class="block text-sm font-semibold text-gray-700 mb-3">
                                Order Notes <span class="text-gray-500 font-normal">(Optional)</span>
                            </label>
                            <textarea id="notes"
                                      name="notes"
                                      rows="4"
                                      class="w-full px-4 py-4 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-4 focus:ring-yellow-100 focus:border-yellow-500 transition-all duration-200 resize-none"
                                      placeholder="Any special delivery instructions, preferred delivery time, or notes for the seller...">{{ old('notes') }}</textarea>
                            @error('notes')
                ...
                <div class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                    <div class="flex items-center mb-8">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 mt-1">Choose how you'd like to pay</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="relative">
                            <input id="cod"
                                   ...
                                   class="sr-only peer"
                                   checked>
                            <label for="cod" class="flex items-center p-6 border-2 border-gray-200 rounded-xl cursor-pointer hover:border-yellow-300 hover:bg-yellow-50 transition-all duration-200 peer-checked:border-yellow-500 peer-checked:bg-yellow-50 peer-checked:shadow-lg">
                                <div class="flex items-center justify-center w-12 h-12 bg-yellow-100 rounded-xl mr-4 peer-checked:bg-yellow-500">
                                    <svg class="w-6 h-6 text-yellow-600 peer-checked:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"></path>
                                    </svg>
                                </div>
                                <div class="flex-1">
                                    <div class="font-semibold text-gray-900 text-lg">Cash on Delivery (COD)</div>
                                    <div class="text-gray-600 mt-1">Pay when your order arrives at your doorstep</div>
                                ...
                                <div class="ml-4">
                                    <div class="w-5 h-5 border-2 border-gray-300 rounded-full peer-checked:border-yellow-500 peer-checked:bg-yellow-500 flex items-center justify-center">
                        ...
                        <div class="relative">
                            <input id="midtrans"
                                   ...
                                   class="sr-only peer"
                                   disabled>
                            <label for="midtrans" class="flex items-center p-6 border-2 border-gray-200 rounded-xl cursor-not-allowed opacity-60 bg-gray-50">
                                ...
                                <div class="flex-1">
                                    <div class="font-semibold text-gray-900 text-lg">Online Payment</div>
                                    <div class="text-gray-600 mt-1">Credit card, bank transfer, e-wallet</div>
                                    <div class="flex items-center mt-2">
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">
                                            <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 sticky top-6">
                        ...
                        @foreach($carts as $cart)
                            <div class="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h4 class="text-sm font-semibold text-gray-900 truncate">{{ $cart->product->product_name }}</h4>
                                    <p class="text-sm text-gray-600">Qty: {{ $cart->quantity }}</p>
                                    <p class="text-sm font-bold text-gray-900 mt-1">Rp {{ number_format($cart->total, 0, ',', '.') }}</p>
                                </div>
                            </div>
                        @endforeach
                    </div>
                    ...
                    <div class="border-t border-gray-200 pt-4 space-y-3">
                        ...
                        <div class="flex justify-between text-sm">
                            ...
                            <span class="font-medium text-yellow-600">Free</span>
                        </div>
...
<div id="successModal" class="fixed inset-0 flex items-center justify-center z-50 p-4">
    <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 transform transition-all duration-300 scale-100">
        ...
        <div class="bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-t-2xl p-6 text-center">
            ...
            <h3 class="text-2xl font-bold text-white">Order Placed Successfully!</h3>
        </div>

        <!-- Modal Body -->
        <div class="p-6">
            <div class="text-center mb-6">
                <p class="text-gray-600 mb-4">Thank you for your order. Your order has been confirmed and is being processed.</p>

                <div class="bg-gray-50 rounded-lg p-4 mb-4">
                    <div class="flex justify-between items-center mb-2">
                        <span class="text-sm text-gray-600">Order Code:</span>
                        <span class="font-mono text-sm font-semibold text-gray-900">{{ session('order_code') }}</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-gray-600">Total Amount:</span>
                        <span class="font-bold text-lg text-yellow-600">Rp {{ number_format(session('order_total'), 0, ',', '.') }}</span>
                    </div>
                </div>
            ...
            <div class="flex space-x-3">
                <button onclick="continueShopping()" class="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-800 font-semibold py-3 px-4 rounded-xl transition-all duration-200 flex items-center justify-center">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path>
                    </svg>
                    Continue Shopping
                </button>
                <button onclick="viewOrders()" class="flex-1 bg-yellow-500 hover:bg-yellow-600 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-200 flex items-center justify-center">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                    </svg>
                    View Orders
