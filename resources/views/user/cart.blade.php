                                    ...
                                    @foreach($carts as $cart)
                                        <div class="flex items-center space-x-4 p-4 border border-gray-200 rounded-lg">
                                            ...
                                            <div class="flex items-center space-x-2">
                                                ...
                                                <input type="number"
                                                       class="quantity-input w-16 px-2 py-1 border border-gray-300 rounded-md text-center focus:outline-none focus:ring-2 focus:ring-yellow-500"
                                                       value="{{ $cart->quantity }}"
                                                       min="1"
                                                       data-cart-id="{{ $cart->id }}">
                                                <button type="button"
                                            ...
                                            <div class="text-right">
                                                <p class="text-lg font-semibold text-gray-900 item-total" data-cart-id="{{ $cart->id }}">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            quantityButtons.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    const checkbox = document.querySelector(`.cart-checkbox[data-cart-id="${cartId}"]`);
