                ...
                <div class="flex gap-4 md:flex-row md:items-end md:gap-6">
                    ...
                    <div class="flex flex-col">
                        ...
                        <select name="category" id="category"
                            class="px-2 py-2 md:px-4 md:py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition-all duration-200 bg-white text-sm md:text-base"
...
<script>
// Unified filter function for desktop and mobile
